...
def predict_image(model, img_path, target_size=TARGET_SIZE):
    """
...
def main():
    ...
    parser.add_argument('--model', default='models/transfer_learning_mobilenetv2_model.h5', help='Path to the trained model')
